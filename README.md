...
最终版本（移除OLED模块，更改GY-86模块位置以适配Madgwick姿态解算，同时更换蓝牙模块为HC-05)：

<img src="README.assets/image-20251029213153499.png" alt="image-20251029213153499" style="zoom: 67%;" />
...
- [x] 四元数与欧拉角的转换
- [x] 四轴飞行器运动机制与模型
- [x] 姿态数据采集及处理（加速度计与高斯牛顿迭代）
- [x] 陀螺仪和地磁数据采集及处理
- [x] 梯度下降及数据处理
- [x] PID反馈控制与数值模拟
- [x] 姿态解算（AHRS:MADGWICK)
- [ ] 数据补偿、拓展卡尔曼滤波（EKF）
- [ ] PID控制器设计、动能分配与系统调试
- [ ] 姿态解算（MAHONY）
- [ ] DARTS实时软件设计方法及研讨
